...
export default function DashboardLayout() {
  ...
  return (
    <div className="app-container">
      <aside className="sidebar fixed top-4 left-4 bottom-4 w-[280px] z-20">
        <div className="brand">
      ...
      <main className="ml-[300px] flex-1 h-[calc(100vh-2rem)] relative flex overflow-hidden w-full gap-4">
